...
function charaInsert(){
    db.transaction(function (tx){
        ...
        tx.executeSql('insert into play_character(pc_id,pc_name,rank,str,dex,pc_int,con,app,pow,siz,edu,profile,characteristic01,characteristic02,characteristic03,pl) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', [3,'アンバー=サットン',1,10,11,15,13,15,10,9,14,'イギリス在住のそれなりに名の知れた考古学者。自分の思う通りにいかないと気が済まない傲慢な性格。資産家の娘であり、学者である両親の影響か珍しいものが大好きで手元に置きたがる。',72,0,0,2])
    })
}