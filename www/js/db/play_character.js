...
function charaInsert(){
    db.transaction(function (tx){
        ...
        tx.executeSql('insert into play_character(pc_id,pc_name,rank,str,dex,pc_int,con,app,pow,siz,edu,profile,profile_1,profile_2,profile_3,profile_4,profile_5,characteristic01,characteristic02,characteristic03,pl) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', [2,'狩野陽子',1,13,10,14,12,14,14,11,16,'図書館司書さん','絆情報Lv.1','絆情報Lv.2','絆情報Lv.3','絆情報Lv.4','絆情報Lv.5',50,0,0,2])    
        tx.executeSql('insert into play_character(pc_id,pc_name,rank,str,dex,pc_int,con,app,pow,siz,edu,profile,profile_1,profile_2,profile_3,profile_4,profile_5,characteristic01,characteristic02,characteristic03,pl) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', [3,'アンバー=サットン',1,10,11,15,13,15,10,9,14,'イギリス在住のそれなりに名の知れた考古学者。','絆情報Lv.1','絆情報Lv.2','絆情報Lv.3','絆情報Lv.4','絆情報Lv.5',72,0,0,2])
    })
}